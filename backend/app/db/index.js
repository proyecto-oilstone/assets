...
const { Cars, CarType, Provider, Files, Users, Sector, Event, DriverEvent, ReportProblemEvent, RepairRequestEvent, WorkshopEvent, VTVEvent, SeguroEvent } = sequelize.models;
